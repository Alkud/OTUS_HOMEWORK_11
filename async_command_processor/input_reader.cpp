...
void InputReader::reactMessage(MessageBroadcaster*, Message message)
{
...
bool InputReader::threadProcess(const size_t)
{
  if (nullptr == inputBuffer)
  {
...
void InputReader::onTermination(const size_t)
{
  #ifdef NDEBUG
  #else
